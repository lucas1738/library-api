...
import static com.lucasbarbosa.libraryapi.driver.utils.ExceptionUtils.buildWithThreeParams;
import static com.lucasbarbosa.libraryapi.driver.utils.ExceptionUtils.getAttributeInUseMessageReference;
  ...
  public Error handleAttributeInUseException(AttributeInUseException ex) {
    return new Error(
        messageSource.getMessage(
            getAttributeInUseMessageReference(),
